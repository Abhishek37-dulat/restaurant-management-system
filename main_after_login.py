...
#
    ...
    def main_graphic_dashboard(self):
        self.main_background_color = "#F1F4F9"
...
# =========================================    main_top_logout ====================================================
        ...
        self.main_top_logout_image = Button(self.main_top_logout,text="   Log out",font=("Comic Sans MS", 10),image=self.main_top_logout_image_3,compound=LEFT, bg=self.main_background_upward_color,activebackground=self.box_on_click,activeforeground=self.box_in_box_background_color, cursor="hand2",anchor=W,borderwidth=0,command=self.logouttt)
...
#======================================  main_Employee_record ========================================================
        ...
        self.main_Employee_record.place(relx=0.01, rely=0.1, relwidth=0.98, relheight=0.9)
...
#=======Total========
        ...
        #
        self.upward_part_of_employee_record_total_inside_image_number = Label(self.upward_part_of_employee_record_total_inside_image,text="2145",font=("Cascadia Mono",20),bg=self.box_on_click, fg=self.main_background_upward_color,anchor=SE)
        ...
        try:
            ...
            if self.tag == "unchecked":
                ...
                if self.ask_to_remove:
                    self.con = pymysql.connect(host="localhost", user="root", password="m81321a",
                                               database="register_rms")
                    self.cur = self.con.cursor()
...
#=================================================  main_item_main ===============================================================================================================
    def main_item_main(self):
        ...
        self.lower_part_of_item_record_fun_view()



    def lower_part_of_item_record_fun_view(self):
        ...
        self.lower_part_of_item_record_background_image_f_view = Frame(self.lower_part_of_item_record_view, bg=self.main_background_upward_color,bd=1,relief="solid")
        self.lower_part_of_item_record_background_image_f_view.place(relx=0, rely=0, relwidth=0.985, relheight=1)

        self.lower_part_of_item_record_background_image_f_view_s = Frame(self.lower_part_of_item_record_view, bg=self.main_background_upward_color,bd=1,relief="solid")
        ...
        self.lower_part_of_item_record_background_image_f_view_title = Frame(self.lower_part_of_item_record_background_image_f_view, bg=self.main_background_upward_color,bd=1,relief="solid")
        self.lower_part_of_item_record_background_image_f_view_title.place(relx=0, rely=0, relwidth=1, relheight=0.07)

        self.lower_part_of_item_record_background_image_f_view_title_image = Label(self.lower_part_of_item_record_background_image_f_view_title,text="Item Image",font=("Kristen ITC",11), bg=self.main_background_upward_color,bd=1,relief="solid")
        self.lower_part_of_item_record_background_image_f_view_title_image.place(relx=0, rely=0, relwidth=0.3, relheight=1)

        self.lower_part_of_item_record_background_image_f_view_title_name = Label(self.lower_part_of_item_record_background_image_f_view_title,text="Item Name",font=("Kristen ITC",11), bg=self.main_background_upward_color,bd=1,relief="solid")
        self.lower_part_of_item_record_background_image_f_view_title_name.place(relx=0.3, rely=0, relwidth=0.3, relheight=1)

        self.lower_part_of_item_record_background_image_f_view_title_price = Label(self.lower_part_of_item_record_background_image_f_view_title,text="Item Price",font=("Kristen ITC",11), bg=self.main_background_upward_color,bd=1,relief="solid")
        self.lower_part_of_item_record_background_image_f_view_title_price.place(relx=0.6, rely=0, relwidth=0.4, relheight=1)


        self.lower_part_of_item_record_background_image_f_view_image_1 = Frame(self.lower_part_of_item_record_background_image_f_view, bg=self.main_background_upward_color,bd=1,relief="solid")
        self.lower_part_of_item_record_background_image_f_view_image_1.place(relx=0, rely=0.07, relwidth=0.3, relheight=0.93)
        self.ddd_1 = Image.open("iii_3.png")
        self.ddd_2 = self.ddd_1.resize((50,50))
        self.ddd_3 = ImageTk.PhotoImage(self.ddd_2)
        self.lower_part_of_item_record_background_image_f_view_image_1 = Label(self.lower_part_of_item_record_background_image_f_view_image_1,image=self.ddd_3, bg=self.main_background_upward_color,bd=1,relief="solid")
        self.lower_part_of_item_record_background_image_f_view_image_1.pack()



        self.lower_part_of_item_record_background_image_f_view_name_1 = Frame(self.lower_part_of_item_record_background_image_f_view, bg=self.main_background_upward_color,bd=1,relief="solid")
        self.lower_part_of_item_record_background_image_f_view_name_1.place(relx=0.3, rely=0.07, relwidth=0.3, relheight=0.93)




        self.lower_part_of_item_record_background_image_f_view_price_1 = Frame(self.lower_part_of_item_record_background_image_f_view, bg=self.main_background_upward_color,bd=1,relief="solid")
        self.lower_part_of_item_record_background_image_f_view_price_1.place(relx=0.6, rely=0.07, relwidth=0.4, relheight=0.93)
        ...
        try:
            ...
            self.tree_image = self.cur.fetchall()
