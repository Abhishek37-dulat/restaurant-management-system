...
class Register:
    def __init__(self,l_root):
        self.root=l_root
        self.l_width=int(self.root.winfo_screenwidth()/1.5)
        self.l_height = int(self.root.winfo_screenheight()/2)
        self.l_x = int(self.root.winfo_screenwidth() / 6)
        self.l_y = int(self.root.winfo_screenheight() / 5)
        ...
        path = "C:/Users/ASUS/PycharmProjects/untitled2/Resturant management system/main_after_login.py"
        self.path = path
    ...
    #====================== Frame1 ========================
        ...
        self.frame1 = Frame(self.root,bg=self.Dark_theme_color)
    ...
    def frame2_main(self,theme,mode_value,light_text_color,dark_text_color,text_bold,text_normal,theme_label_color):
          ...
          self.frame2_1 = Frame(self.root, bg=self.Dark_theme_color)
...
#=========================== login_background_frame 1 ==============================
        self.login_background_frame1 = Frame(self.root, bg=self.Dark_theme_color)
...
#=========================== create_background_frame 1 ==============================
        self.create_new_account_background_frame1 = Frame(self.root, bg=self.Dark_theme_color)
